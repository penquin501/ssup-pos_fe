  ...
  <div>
    <b-card>
      <b-tabs content-class="mt-3">
        <b-tab
          v-if="listMenu.find((name) => name == 'Offer Promotion')"
          title="Promotion"
          active
        >
          <v-data-table
          ...
          >
            ...
            <template v-slot:top>
              <v-toolbar flat>
                ...
                <v-text-field
                  ...
                  @keypress.enter="checkMemberPromotion()"
            ...
            <template v-slot:item.img="{ item }">
              <div>
                <v-btn @click="openDialog(item.img)" plain style="width: 100px; height: 100px">
            ...
            <template v-slot:expanded-item="{ headers, item }">
              <td :colspan="headers.length" style="padding-top: 16px; padding-bottom: 16px;">
                <p style="word-wrap: break-word; margin-bottom: 0px;">{{ item.description }}</p>
              </td>
            </template>
          </v-data-table>
          <v-dialog
          ...
          >
            ...
            >
              <v-card
                ...
                max-width="500px"
                light
                style="width: 200vw; height: auto; margin: 0"
              >
                <v-card-title>
                  <b>Promotion</b>
                  <v-spacer></v-spacer>
                  <v-btn
                    icon
                    @click.prevent="
                      (dialogPromotion = false), (overlayPromotion = false)
                    "
                ...
                <v-card-text class="text--primary">
                  ...
                  <v-row>
                    <v-col cols="6" align="center">
                      <v-btn @click.prevent="rotateLeft"
                        ><v-icon>mdi-rotate-left</v-icon></v-btn
                      >
                    </v-col>
                    <v-col cols="6" align="center">
                      <v-btn @click.prevent="rotateRight"
...
export default {
  data() {
    return {
      ...
      headers: [
        { text: "No", value: "index" },
        { text: "Promotion Code", sortable: true, value: "code" },
        { text: "Promotion Name", value: "name" },
