    ...
    <v-card class="text-center" max-width="450px">
      <v-card-text>
        ...
        <v-row>
          ...
          <v-col class="pa-0 text-left">{{ userInfo.data.brand_tax_id }}</v-col>
          <v-col class="pa-0 text-right">POS ID:</v-col>
          <v-col class="pa-0 text-right">{{
            receiptInfo.main[0].pos_id
          }}</v-col>
        </v-row>
        <v-row>
          <v-col class="pa-0 text-left">Branch:</v-col>
          <v-col class="pa-0 text-left">{{ userInfo.data.branch }}</v-col>
        ...
        <v-row>
          <v-col class="pa-0 text-left"
            >คะแนนที่จะหมดอายุ(วันที่ 31/12/2022)</v-col
          >
          <v-col class="pa-0 text-right">{{
            receiptInfo.main[0].point_before
          }}</v-col>
